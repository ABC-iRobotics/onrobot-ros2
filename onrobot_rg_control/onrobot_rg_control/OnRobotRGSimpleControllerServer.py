...
class OnRobotRGNode(Node):
    ...
    def initParams(self):
        ...
        try:
            self.joint_states_pub = self.declare_parameter('/onrobot/joint_states_pub_name', value='/joint_states').get_parameter_value().string_value
        except:
            self.joint_states_pub = self.get_parameter('/onrobot/joint_states_pub_name').get_parameter_value().string_value
    ...
    def initIsaacSim(self):
        try:
            self.joint_states_sub = self.declare_parameter('/onrobot/joint_states_sub_name', value='/joint_states').get_parameter_value().string_value
        except:
